...
RUN wget -O /usr/share/cura/Ultimaker_Cura.AppImage https://github.com/Ultimaker/Cura/releases/download/$CURA_VERSION/Ultimaker-Cura-$CURA_VERSION-linux-modern.AppImage
